...
delete from public.grant_admin where grant_admin_id in ('-1', '-2', '-3', '-4', '-5');

delete from public.grant_applicant where id in ('-1', '-2', '-3', '-4', '-5');
...
delete from public.grant_applicant_organisation_profile where applicant_id in ('-1', '-2', '-3', '-4', '-5');
