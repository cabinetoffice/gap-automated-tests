...
describe("Apply for a Grant", () => {
  ...
  it(
    "can start and submit new grant application",
    {
      retries: {
        runMode: 1,
        openMode: 0,
  ...
  it(
    "can start, save, come back, continue and submit new grant application",
    {
      retries: {
        runMode: 1,
        openMode: 0,
  ...
  it(
    "test that doc upload is required for relevant application form",
    {
      retries: {
        runMode: 1,
        openMode: 0,
  ...
  it(
    "can land on application dashboard and view details",
    {
      retries: {
        runMode: 1,
        openMode: 0,
