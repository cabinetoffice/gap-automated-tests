...
describe("Create a Grant", () => {
  ...
  it(
    "can create a new Grant and create advert",
    {
      retries: {
        runMode: 1,
        openMode: 0,
    ...
    () => {
      ...
      function createGrant() {
        ...
        cy.get(
          "[data-cy='cy_summaryListValue_Support email address']",
      ...
      function advertSection3() {
        ...
        cy.get("[data-cy=cyDateFilter-grantApplicationCloseDateDay]").type(
          "31",
        );
      ...
      function advertSection1() {
        ...
        cy.get("[data-cy=cy-grantFunder-text-input]").type(
          "The Cabinet Office",
        );
